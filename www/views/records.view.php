		...
		<table class="table table-striped table-bordered table-hover" id="records">
			...
			<tbody>
				<form action="/" role="form" id="newNode" method="post">
					<tr>
						<td class="l-date-col"><input required type="text" class="form-control datepicker" id="dateInput" placeholder="Enter date"></td>
						<td class="l-type-col">
						...
						<td class="l-activity-col"><input required autofocus type="text" class="form-control" id="activityInput" placeholder="Enter activity"></td>
						<td class="l-estimate-col"><input required type="number" class="form-control" id="estimateInput" placeholder="Enter estimate time"></td>
						<td cass="l-real-col"><input required type="number" class="form-control" id="realInput" placeholder="Enter real time"></td>
