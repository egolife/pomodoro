...
<section class="container l-main">
	...
	<h1>Составление плана на <a href="/">сегодня</a> <?php echo date('d-m-Y'); ?>
  <br>
  <small>Помни: ставить задачи с понятным и конкретным признаком выполнения (никаких "освоить")</small><br>
  <small>Формат "освоить", "узнать" и тд это цели, а не задачи</small><br>
  <small>Задачи бывают текущие и тактические/стратегические (приближают цели, повышают навыки)</small>
  </h1>
